...
public class PutReexportForExtendedClassifier_QuickFix extends QuickFix_Runtime {
  ...
  public void execute(SNode node) {
    ...
    ((AbstractModule2) PutReexportForExtendedClassifier_QuickFix.this.getField("module")[0]).addDependency(((SModule) PutReexportForExtendedClassifier_QuickFix.this.getField("moduleToImport")[0]).getModuleReference(), reexport);
  }
}
