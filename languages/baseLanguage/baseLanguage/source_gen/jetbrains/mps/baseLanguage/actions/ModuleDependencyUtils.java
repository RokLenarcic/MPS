...
public class ModuleDependencyUtils {
  public static void addDependencyOnJDKIfMissing(SModule currentModule) {
    if (currentModule instanceof AbstractModule2) {
      ((AbstractModule2) currentModule).addDependency(PersistenceFacade.getInstance().createModuleReference("6354ebe7-c22a-4a0f-ac54-50b52ab9b065(JDK)"), false);
    }
  }
