...
public class LanguageAspectsEP_extension extends Extension.Default<LanguageAspectDescriptor> {
  ...
  public LanguageAspectDescriptor get() {
    return new LanguageAspectDescriptor() {
      ...
      @Override
      public int compareTo(OrderParticipant2<String> other) {
      ...
      public Collection<SLanguage> getMainLanguages() {
        return ListSequence.fromListAndArray(new ArrayList<SLanguage>(), MetaAdapterFactory.getLanguage(0xaf65afd8f0dd4942L, 0x87d963a55f2a9db1L, "jetbrains.mps.lang.behavior"), MetaAdapterFactory.getLanguage(0x7866978ea0f04cc7L, 0x81bc4d213d9375e1L, "jetbrains.mps.lang.smodel"));
      }
      @Nullable
  ...
  private static final String HELP_URL_ecu8yf_a0a7a0a0a1 = URLFunction_HelpCenterDocUrl.getUrl() + "/behavior.html";
}
