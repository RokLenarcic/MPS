...
@GeneratedClass(node = "r:86c973b9-f718-41ea-a160-01462892e653(jetbrains.mps.ide.mpsmigration.v_2019_1)/3701865296871042751", model = "r:86c973b9-f718-41ea-a160-01462892e653(jetbrains.mps.ide.mpsmigration.v_2019_1)")
public class UpdateJavaStubMethodRefs extends BaseProjectMigration {
  private static final Logger LOG = LogManager.getLogger(UpdateJavaStubMethodRefs.class);
  public UpdateJavaStubMethodRefs() {
    super("jetbrains.mps.ide.mpsmigration.v191." + UpdateJavaStubMethodRefs.class.getSimpleName());
  }
