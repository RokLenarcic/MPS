...
public class RelativePathHelper {
  ...
  public static RelativePathHelper forModule(SModule module) {
    if (module == null || ((AbstractModule2) module).getDescriptorFile() == null || module.isPackaged()) {
      return null;
    }
    String basePath = ((AbstractModule2) module).getDescriptorFile().getParent().getPath();
