...
public class MigrationExecutorImpl implements MigrationExecutor {
  ...
  private void executeMigrationScript(ScriptApplied<MigrationScriptReference> sa) {
    ...
    AbstractModule2 module = ((AbstractModule2) sa.getModule(myProject.getRepository()));
  ...
  private void executeRefactoringScript(ScriptApplied<RefactoringScriptReference> sa) {
    ...
    final AbstractModule2 module = ((AbstractModule2) sa.getModule(myProject.getRepository()));
  ...
  private <IP, FP> void doRun(AbstractModule2 module, RefactoringParticipant.PersistentRefactoringParticipant<?, ?, IP, FP> participant, RefactoringUI ui, Iterable<SNode> initialState, final Map<SNode, SNode> initialToFinal, RefactoringSession refactoringSession) {
