...
public class MigrationDataUtil {
  public static void saveData(AbstractModule2 module, Iterable<Tuples._2<MigrationScriptReference, SNode>> data) {
  ...
  public static Iterable<Tuples._2<MigrationScriptReference, SNode>> loadData(AbstractModule2 module) {
    IFile file = getDataFile(module);
    if (!(file.exists())) {
  ...
  public static void addData(SModule module, MigrationScriptReference script, SNode data) {
    List<Tuples._2<MigrationScriptReference, SNode>> loadedData = Sequence.fromIterable(loadData((AbstractModule2) module)).toListSequence();
    ListSequence.fromList(loadedData).addElement(MultiTuple.<MigrationScriptReference,SNode>from(script, data));
    saveData((AbstractModule2) module, loadedData);
  }
  ...
  private static IFile getDataFile(AbstractModule2 module) {
