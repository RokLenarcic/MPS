...
@GeneratedClass(node = "r:147fb550-8026-46fe-830c-81449036a4c3(jetbrains.mps.java.workbench.actions)/4326588611400156604", model = "r:147fb550-8026-46fe-830c-81449036a4c3(jetbrains.mps.java.workbench.actions)")
public class MigrateSourcesToMPS_Action extends BaseAction {
  ...
  public boolean isApplicable(AnActionEvent event, final Map<String, Object> _params) {
    ModuleDescriptor moduleDescr = ((AbstractModule2) ((SModule) MapSequence.fromMap(_params).get("module"))).getModuleDescriptor();
