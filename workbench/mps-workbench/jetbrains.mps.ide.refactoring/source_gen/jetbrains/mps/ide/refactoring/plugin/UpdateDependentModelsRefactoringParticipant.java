          ...
          public void confirm(final SModelReference finalState, final SRepository repository, RefactoringSession refactoringSession) {
            refactoringSession.registerChange(new Runnable() {
              public void run() {
                ...
                if (usage.getModule() instanceof AbstractModule2 && !(new GlobalModuleDependenciesManager(usage.getModule()).getModules(GlobalModuleDependenciesManager.Deptype.VISIBLE).contains(targetModule))) {
                  ((AbstractModule2) usage.getModule()).addDependency(targetModule.getModuleReference(), false);
                }
              }
            });
          }
