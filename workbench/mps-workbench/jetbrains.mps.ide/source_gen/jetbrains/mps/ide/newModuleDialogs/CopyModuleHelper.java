...
public final class CopyModuleHelper {
  ...
  private final AbstractModule2 myOriginal;
  private final String myCopyName;
  private final IFile myCopyLocation;
  private final String myVirtualFolder;

  public CopyModuleHelper(MPSProject project, AbstractModule2 originalModule, String newModuleName, IFile newModuleLocation, String virtualFolder) {
    myProject = project;
  ...
  @Nullable
  public AbstractModule2 copy() throws CopyNotSupportedException {
  ...
  private void copyModelsAndFacets(AbstractModule2 copy) throws CopyNotSupportedException {
  ...
  private <E extends Exception> AbstractModule2 recover(E e, AbstractModule2 result) throws E {
    result.getModuleSourceDir().deleteIfExists();
    throw e;
  }

  private void addModuleToProject(AbstractModule2 result) {
   ...
   */
  private AbstractModule2 createModule(IFile resultFile, ModuleDescriptor copyDescriptor) {
    ...
    return (AbstractModule2) result;
  }

  private void adjustReferences(AbstractModule2 copy) throws ReferenceUpdater.RefUpdateException {
  ...
  private static void copyModelRoots(AbstractModule2 source, AbstractModule2 target) throws CopyNotSupportedException {
   ...
   */
  public static void copyFacets(AbstractModule2 source, AbstractModule2 target) throws CopyNotSupportedException {
    // nop 
  }
}
