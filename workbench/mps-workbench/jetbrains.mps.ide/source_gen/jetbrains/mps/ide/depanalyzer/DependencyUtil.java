...
public class DependencyUtil {
  ...
  private List<DepLink> dependencies(Role role, SModuleReference moduleRef) {
    ...
    switch (role) {
      ...
      case DependencyDevkit:
        ...
        DevkitDescriptor devkit = as_he47wm_a0a1a3d0g(((AbstractModule2) module).getModuleDescriptor(), DevkitDescriptor.class);
        if (devkit == null) {
          break;
        }
  ...
  private void addUsedLanguagesAndDevkitsOf(SModule module, List<DepLink> result, boolean initialNotDependency) {
    ...
    AbstractModule2.LangAndDevkits actualUses = ((AbstractModule2) module).collectLanguagesAndDevkits();
